        ...
        <table width="100%">
            ...
            <tr>
                <td><table>
                        ...
                        <tr>
                            <td></td>
                            <td><p class="location">location: <a href="index.php">home</a> / form error</p></td>
                            <td></td>
                        </tr>
                        <tr class="top">
                            <td id="nav"><?php
                            ...
                            <td id="content">
                            	<h1>Oops!</h1>
                                <p>You seem to have forgotten some important information or your email address appears to be invalid!</p>
                                <p>Please click <a style="cursor:pointer" onclick="goBack()">here</a> or use the back button in your browser to go back to the form.</p>
            				</td>
                            <td id="posters">
