        ...
        <table width="100%">
            ...
            <tr>
                <td><table>
                        ...
                        <tr>
                            <td></td>
                            <td><p class="location">location: <a href="index.php">home</a> / <a href="youngAdults.php">young adults</a> / info for new british columbians</p></td>
                            <td></td>
                        </tr>
                        <tr class="top">
                            <td id="nav"><?php
                            ...
                            <td id="content">
                            	<h1>Info for New British Columbians</h1>
