        ...
        <table width="100%">
            ...
            <tr>
                <td><table>
                        ...
                        <tr>
                            <td></td>
                            <td><p class="location">location: <a href="index.php">home</a> / <a href="about.php">about us</a> / staff team</p></td>
                            <td></td>
                        </tr>
                        <tr class="top">
                            <td id="nav"><?php
                            ...
                            <td id="content">
                            	<h1>Vancouver Hillel’s Staff Team</h1>
				...
				<h2>Exciting staff updates coming soon!!</h2>
                                ...
                                <h2>Orit Goldfarb, executive office manager </h2>
                                <a href="mailto:Orit Goldfarb<info@vancouverhillel.ca>">info@vancouverhillel.ca</a>
                                <p>Originally from Israel, Orit joined Vancouver Hillel in the fall of 2006 as the Executive Office Manager.  She is integral in all of the operations that occur at Vancouver Hillel.</p>
                                
                                <h2>Maggie Yonash, special events coordinator</h2>
                                ...
                                <p>Born in Mexico, Ayelet moved to Victoria after serving in the Israeli Defense Force. At UVic Ayelet completed a degree in International Relations. She is now joining Hillel for her second year as the <a href="uvic.php">UVic</a> Director. In this position, she will be affecting and motivating programming for the Victoria student community as well as managing the University of Victoria Hillel House.</p>
                                
                                 <h2>Ben Rabinovitch, webmaster</h2>
                                <a href="mailto:Ben Rabinovitch<webmaster@vancouverhillel.ca>">webmaster@vancouverhillel.ca</a>
                                <p>A graduate of Computing Sciences at <a href="sfu.php">SFU</a>, Ben Rabinovitch put his degree to good use when constructing this Vancouver Hillel website. In addition to being a webmaster, Ben has a plethora of other work and volunteer experience including working as the SFU Director and <a href="http://www.israelforfree.com" target="_blank">Taglit-Birthright: CIE</a> British Columbia Director for Vancouver Hillel.</p>
            				</td>
                            <td id="posters">
                                <?php
									$maxPosters = 2;
